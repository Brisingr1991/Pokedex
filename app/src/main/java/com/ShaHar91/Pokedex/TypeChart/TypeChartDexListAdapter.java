...
public class TypeChartDexListAdapter extends BaseAdapter implements
        FilterQueryProvider {
    ...
    public TypeChartDexListAdapter(Context context,
                                   ArrayList<PokeDexListItems> list) {
        ctx = context;
        pokeDexList = list;
