...
public class moveTab1 extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.move_tab_1_lvl, container,
                false);
        return rootView;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor listCursor = databaseConnector.getAllPokeMoves(rowID, 1);
    ...
    private class MyListAdapter extends ResourceCursorAdapter {
        ...
        public MyListAdapter(Context context, Cursor c) {
            super(context, R.layout.move_tab_1_lvl_item, c);
        }
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            lvl.setText("lvl. "
                    + cursor.getString(cursor.getColumnIndex("moveTypeLevel")));
