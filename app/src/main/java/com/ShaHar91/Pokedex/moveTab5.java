...
public class moveTab5 extends ListFragment {
    private long rowID;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.move_tab_5_pre, container,
                false);
        return rootView;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor listCursor = databaseConnector.getAllPokeMoves(rowID, 5);
    ...
    private class MyListAdapter extends ResourceCursorAdapter {
        ...
        public MyListAdapter(Context context, Cursor c) {
            super(context, R.layout.move_tab_5_pre_item, c);
        }
