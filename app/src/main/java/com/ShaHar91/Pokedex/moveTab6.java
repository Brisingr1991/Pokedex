...
public class moveTab6 extends ListFragment {
    private long rowID;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.move_tab_6, container, false);
        return rootView;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor listCursor = databaseConnector.getAllPokeMoves(rowID, 6);
    ...
    private class MyListAdapter extends ResourceCursorAdapter {
        ...
        public MyListAdapter(Context context, Cursor c) {
            super(context, R.layout.move_tab_6_item, c);
        }
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            lvl.setText(cursor.getString(cursor.getColumnIndex("moveTypeLevel")));
