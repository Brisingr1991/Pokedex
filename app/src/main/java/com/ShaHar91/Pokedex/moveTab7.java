...
public class moveTab7 extends ListFragment {
    private long rowID;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.move_tab_7, container, false);
        return rootView;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor listCursor = databaseConnector.getAllPokeMoves(rowID, 7);
    ...
    private class MyListAdapter extends ResourceCursorAdapter {
        ...
        public MyListAdapter(Context context, Cursor c) {
            super(context, R.layout.move_tab_7_item, c);
        }
