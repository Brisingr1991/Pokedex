...
public class AbilitiesListExpandable extends ExpandableListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameAbility = extras.getString("name");

        setTitle(nameAbility);
    ...
    private void fillData() {
        Cursor mGroupsCursor = databaseConnector.fetchAbilityGroup();
        mGroupsCursor.moveToFirst();

        setListAdapter(new MyExpandableListAdaptersecond(
                AbilitiesListExpandable.this, mGroupsCursor,
    ...
    public class MyExpandableListAdaptersecond extends
        ...
        protected Cursor getChildrenCursor(Cursor groupCursor) {
            ...
            Cursor childCursor = databaseConnector.fetchAbilityChildren(
                    text.toString(), rowID);
        ...
        protected void bindGroupView(View view, Context context, Cursor cursor,
            ...
            group.setText(cursor.getString(cursor.getColumnIndex("ability_type")));
